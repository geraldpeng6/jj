...
该脚本用于测试获取策略库列表的API功能，包括：
1. 向策略库列表API发送请求
2. 将完整的请求体(request body)记录到测试日志文件中
3. 将完整的响应内容(response)记录到同一个测试日志文件中
4. 提供适当的错误处理机制
"""
...
def setup_logging(log_file: str = None) -> logging.Logger:
    ...
    """
    # 创建日志记录器
    logger = logging.getLogger('strategy_library_api_test')
...
def test_strategy_library_api(base_url: str = "https://api.yueniusz.com") -> bool:
    """
    测试获取策略库列表的API功能
